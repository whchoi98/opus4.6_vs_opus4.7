---
name: code-review
description: Review recent code changes against project conventions. Use when mentioning code review, PR review, or code quality check.
---
