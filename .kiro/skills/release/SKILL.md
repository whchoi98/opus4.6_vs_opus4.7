---
name: release
description: Tag a benchmark release — a reproducible snapshot of config + results. Use when mentioning release, versioning, changelog, or tagging.
---
...
- When a set of findings is ready to share externally
...
7. Update KIRO.md and CLAUDE.md "Known state" section with latest cumulative cost and test count
